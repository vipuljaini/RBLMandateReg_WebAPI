...
namespace EntityDAL
{
    ...
    public partial class tblEntity
    {
        ...
        public Nullable<bool> IsAPIValidation { get; set; }
        public Nullable<bool> IsAadharbaseValidation { get; set; }
        public string RefInputvalues { get; set; }
        public string RefDefaultfirst { get; set; }
        public Nullable<int> perioddate { get; set; }
        public Nullable<int> perioddays { get; set; }
        public Nullable<int> fromdateparams { get; set; }
        public Nullable<bool> printSponsorcode { get; set; }
        public Nullable<long> ReqID { get; set; }
        public string Ref1Alternatename { get; set; }
        public string Ref2Alternatename { get; set; }
        public string RefMaxLength { get; set; }
        public string Emandateinitiation { get; set; }
        public string Emandateresp { get; set; }
        public string physicalmandate { get; set; }
        public string phymandateresp { get; set; }
        public string Presentationinitiation { get; set; }
        public string MandatorysetupOnNach { get; set; }
        public string LogoQRSetup { get; set; }
        ...
        public string Aadharinitiation { get; set; }
