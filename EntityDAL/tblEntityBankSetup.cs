...
namespace EntityDAL
{
    ...
    public partial class tblEntityBankSetup
    {
        ...
        public string Requestfilefolder { get; set; }
        public string Responsefilefolder { get; set; }
        public Nullable<bool> IsFileFormatTxt { get; set; }
        public string Fileformat { get; set; }
        public string BatchProcessingTime { get; set; }
    }
}
